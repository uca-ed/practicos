...
def armarSecuencia(anteriores, nodoDestino):
    secuencia = []
    actual = nodoDestino
    while actual != 0:
            ...
            if matriz[nodo - 1][columna] == 1:
                ...
                if not visitados[columna]:
                    ...
                    if vecino == nodoDestino:
                        secuencia = armarSecuencia(anteriores, nodoDestino)
                        print(f"El paso del nodo {nodoOrigen} al nodo {nodoDestino} es:", secuencia)
                        return

    print(f"No existe paso del nodo {nodoOrigen} al nodo {nodoDestino}")
