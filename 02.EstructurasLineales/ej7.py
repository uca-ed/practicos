...
def main():
    ...
    # Uso el mismo archivo que en el ej5
    ...
    if resultado is None:
        print("El grafo es CÍCLICO, no es posible realizar el Sort Topológico.")
    else:
...
# La única diferencia con el ejercicio 5 es que ese pedía detectar ciclos además de ordenar,
# y este solo pide el sort topológico, pero el código ya contempla ambas cosas.
